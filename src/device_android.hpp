...
struct SensorInfo
{
    ...
    SensorInfo() : sensor(nullptr), active(false) {};
};
...
public:
    ...
    bool isAccelerometerAvailable() {return m_accelerometer.sensor != nullptr;}
    bool isGyroscopeActive() {return m_gyroscope.active;}
    bool isGyroscopeAvailable() {return m_gyroscope.sensor != nullptr;}
};
